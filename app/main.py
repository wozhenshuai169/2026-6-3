...
from app.api.avatar_settings import router as avatar_settings_router
...
app = FastAPI(title="云游智导景区导览服务", version="2.0.0", lifespan=lifespan)
app.add_middleware(
    CORSMiddleware,
...
app.include_router(avatar_settings_router)
...
@app.get("/")
async def root():
    return RedirectResponse(url="/pages/landing/index.html", status_code=307)
